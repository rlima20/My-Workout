...
fun List<TrainingModel>.toEntityList(): List<TrainingEntity> {
    return this.map { trainingModel ->
        TrainingEntity(
            ...
            trainingName = trainingModel.trainingName,
            isChecked = trainingModel.isChecked,
            myNotes = trainingModel.myNotes
        )
    }
}
...
fun List<TrainingEntity>.toModelTrainingList(): List<TrainingModel> {
    return this.map { trainingEntity ->
        TrainingModel(
            ...
            myNotes = trainingEntity.myNotes
        )
    }
}
...
fun List<MuscleSubGroupEntity>.toModelMuscleSubGroupList(): List<MuscleSubGroupModel> {
    return this.map { muscleSubGroupEntity ->
        MuscleSubGroupModel(
